...
def main() -> None:
    ...
    try:
        ...
        logger.info("-" * 80)
        logger.info("  → Saved: results/predictions/predictions_xgboost_w2.csv")
        ...
        logger.error("Unexpected error during XGBoost: %s", e)
        raise
