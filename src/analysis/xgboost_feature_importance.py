...
importance_path = PROJECT_ROOT / "results" / "tables" / "xgboost_feature_importance.csv"
...
def main():
    ...
    try:
        ...
        output_path = OUTPUT_DIR / '10_xgboost_feature_importance.png'
        ...
        # Save
        output_path = OUTPUT_DIR / '10b_xgboost_cumulative_importance.png'
        plt.savefig(output_path, dpi=300, bbox_inches='tight')
        logger.info(f"Saved to {output_path}")
        plt.close()
