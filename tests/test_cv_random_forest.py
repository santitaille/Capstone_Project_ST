...
def main() -> None:
    ...
    logger.info("=" * 80)
    logger.info("RANDOM FOREST CROSS-VALIDATION TEST")
    logger.info("=" * 80)
    print()
    ...
    # Define Random Forest model (same hyperparams as in ML model)
    ...
    cv_scores = cross_val_score(rf, x_train, y_train_log, cv=cv, scoring="r2")
    ...
    train_r2 = rf.score(x_train, y_train_log)
